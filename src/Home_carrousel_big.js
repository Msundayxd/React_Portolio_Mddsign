...
function Carrousel () {
  ...
  const items = [
    { imageSrc: FirstImgCar, text: 'CREATING A PORTFOLIO WITH REACT', id: 'imgcar1', uidesign: true, uxdesign: true, graphicdesign: false, programming: true },
    { imageSrc: SecondImgCar, text: 'HEEK: A HEALTHY LIFESTYLE SOLUTION', id: 'imgcar2', uidesign: true, uxdesign: true, graphicdesign: true, programming: false},
